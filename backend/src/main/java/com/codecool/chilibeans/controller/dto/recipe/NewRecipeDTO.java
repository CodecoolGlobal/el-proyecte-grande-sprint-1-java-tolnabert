...
public record NewRecipeDTO(String name, String description, Set<Diet> diets, Set<Ingredient> ingredients, List<Step> steps, int portions, String image, Client createdBy) {
}
