...
public record RecipeDTO(UUID publicId, String name, String description, Set<Diet> diets, Set<Ingredient> ingredients, List<Step> steps, int portions, String image, User createdBy, LocalDate createdAt) {
}
