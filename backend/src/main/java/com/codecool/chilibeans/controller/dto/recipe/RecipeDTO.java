...
public record RecipeDTO(UUID publicId, String name, String description, Set<DietDTO> diets, Set<Ingredient> ingredients, List<Step> steps, int portions, String image, UUID createdBy, LocalDate createdAt) {
}
